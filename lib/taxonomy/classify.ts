...
const MANAGEMENT_ROLE = String.raw`manager|director|chief|supervisor|vice president`;
...
const RULES: ReadonlyArray<{ pattern: RegExp; category: Category }> = [
  ...
  { pattern: /\b(personal support worker|health care aide|care aide|continuing care assistant|resident assistant|home care attendant|community care assistant|home support worker|patient support assistant|patient attendant|porter|orderly)\b/, category: 'support_care' },
  ...
  { pattern: /\b(pharmacist|pharmacy technician|pharmacy assistant|pharmacy specialist|pharmacy practice assistant|pharmacy student|pharm d|pharmd)\b/, category: 'pharmacy' },
